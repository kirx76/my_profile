      ...
      <div className={styles.Philosophy}>
        <div className={styles.Philosophy_Left}>
          ...
          <div className={styles.Philosophy_Left_Content}>
            <span>I think everyone wants the same thing - relationship with humanity, peace with the metaphysical, and experience with the universe. I try to grasp these things with my values: authenticity, creativity, & hospitality.</span>
          </div>
