    ...
    return (
      <div className={styles.Posts}>
        <div className={styles.Posts_Header}>
          ...
          <div className={styles.Posts_Header_Description}>Work that I’ve done for the past 8 years</div>
        </div>
    ...
    <div className={styles.Posts_Item}>
      <div className={styles.Posts_Item_Container}>
        ...
        <div className={styles.Posts_Item_Container_Text}>
          <div className={styles.Posts_Item_Container_Text_Title}>{item.title}</div>
          <div className={styles.Posts_Item_Container_Text_Description}>{item.description}</div>
        </div>
      </div>
    </div>
  )
